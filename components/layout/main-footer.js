  ...
  <footer>
    <div className="content">
      <ul className="social-links">
        ...
        <li>
          <a href="https://twitter.com/garita_center" target="_blank" rel="noopener noreferrer">
            <svg width="50" height="50" viewBox="0 0 30 30">
              <circle cx="15" cy="15" r="15" fill="#666" />
        ...
        <li>
          <a href="https://plus.google.com/102476216230239359040" target="_blank" rel="noopener noreferrer">
